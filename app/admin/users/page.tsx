  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 page-enter space-y-6">
      <div>
        ...
        <p className="text-zinc-400 text-sm mt-1">All registered platform users</p>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-800">
                  <th className="text-left px-5 py-3 text-zinc-400 text-xs font-medium uppercase tracking-wider">Name</th>
                  <th className="text-left px-5 py-3 text-zinc-400 text-xs font-medium uppercase tracking-wider">Email</th>
                  <th className="text-left px-5 py-3 text-zinc-400 text-xs font-medium uppercase tracking-wider">Role</th>
                  <th className="text-left px-5 py-3 text-zinc-400 text-xs font-medium uppercase tracking-wider">Joined</th>
                </tr>
              </thead>
              <tbody>
                {profiles?.map((profile) => (
                  <tr key={profile.id} className="border-b border-zinc-800/50 hover:bg-zinc-900/50">
